...
Item {
    ...
    */
    property bool interactive: false //true
    ...
    */
    ...
    Rectangle{
        x: control.diameter*0.175
        y: control.diameter*0.115
        width: control.progressWidth*1.2
        height: control.progressWidth*1.2
        radius: control.progressWidth*1.2/2
        rotation: control.rotation
        color: "#D94625"
        Text{
            text: control.maxValue
            font.family: "Verdana"
            font.pointSize: 5
            font.bold: true
            color: "lightgray"
